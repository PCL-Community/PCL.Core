...
public static partial class Config {
    ...
    [ConfigGroup("System")] partial class SystemConfigGroup {
        ...
        [ConfigItem<int>("SystemLastVersionReg", 0, ConfigSource.SharedEncrypt)]
        public partial int LastVersion { get; set; }
        [ConfigItem<int>("SystemHighestSavedBetaVersionReg", 0, ConfigSource.SharedEncrypt)]
        public partial int LastSavedBetaVersion { get; set; }
        [ConfigItem<int>("SystemHighestBetaVersionReg", 0, ConfigSource.SharedEncrypt)]
        public partial int LastBetaVersion { get; set; }
        [ConfigItem<int>("SystemHighestAlphaVersionReg", 0, ConfigSource.SharedEncrypt)]
        public partial int LastAlphaVersion { get; set; }
        ...
        [ConfigItem<string>("SystemSystemAnnouncement", "", ConfigSource.Local)]
        public partial string ShowedAnnouncements { get; set; }
        [ConfigItem<string>("SystemHttpProxy", "", ConfigSource.SharedEncrypt)]
        public partial string HttpProxy { get; set; }
        ...
        [ConfigItem<string>("SystemMirrorChyanKey", "", ConfigSource.SharedEncrypt)]
        public partial string MirrorChyanKey { get; set; }
        ...
        [ConfigItem<string>("LoginLegacyName", "", ConfigSource.SharedEncrypt)]
        public partial string LoginLegacyName { get; set; }
    ...
    [ConfigGroup("Cache")] partial class CacheConfigGroup {
        ...
        [ConfigItem<string>("CacheAuthUsername", "", ConfigSource.SharedEncrypt)]
        public partial string AuthThirdPartyUserName { get; set; }
        [ConfigItem<string>("CacheAuthPass", "", ConfigSource.SharedEncrypt)] public partial string AuthPassword { get; set; }
        [ConfigItem<string>("CacheAuthServerServer", "", ConfigSource.SharedEncrypt)]
        public partial string AuthServerAddress { get; set; }
    }
    ...
    [ConfigGroup("Link")] partial class LinkConfigGroup {
        ...
        [ConfigItem<string>("LinkAnnounceCache", "", ConfigSource.SharedEncrypt)]
        public partial string AnnounceCache { get; set; }
        ...
        [ConfigItem<string>("LinkNaidRefreshToken", "", ConfigSource.SharedEncrypt)]
        public partial string NaidRefreshToken { get; set; }
        [ConfigItem<string>("LinkNaidRefreshExpiresAt", "", ConfigSource.SharedEncrypt)]
        public partial string NaidRefreshExpireTime { get; set; }
        [ConfigItem<bool>("LinkFirstTimeNetTest", true, ConfigSource.SharedEncrypt)]
        public partial bool DoFirstTimeNetTest { get; set; }
    }
    ...
    [ConfigGroup("Ui")] partial class UiConfigGroup {
        ...
        [ConfigGroup("Hide")] partial class HideConfigGroup {
            ...
            [ConfigItem<bool>("UiHiddenFunctionSelect", false, ConfigSource.Local)]
            public partial bool FunctionSelect { get; set; }
            [ConfigItem<bool>("UiHiddenFunctionModUpdate", false, ConfigSource.Local)]
            public partial bool FunctionModUpdate { get; set; }
            [ConfigItem<bool>("UiHiddenFunctionHidden", false, ConfigSource.Local)]
            public partial bool FunctionHidden { get; set; }
            ...
            [ConfigItem<bool>("UiHiddenVersionScreenshot", false, ConfigSource.Local)]
            public partial bool InstanceScreenshot { get; set; }
            [ConfigItem<bool>("UiHiddenVersionMod", false, ConfigSource.Local)] public partial bool InstanceMod { get; set; }
            [ConfigItem<bool>("UiHiddenVersionResourcePack", false, ConfigSource.Local)]
            public partial bool InstanceResourcePack { get; set; }
            [ConfigItem<bool>("UiHiddenVersionShader", false, ConfigSource.Local)] public partial bool InstanceShader { get; set; }
            [ConfigItem<bool>("UiHiddenVersionSchematic", false, ConfigSource.Local)]
            public partial bool InstanceSchematic { get; set; }
        }
    }
    ...
    [ConfigGroup("Launch")] partial class LaunchConfigGroup {
        ...
        [ConfigItem<string>("LaunchAdvanceJvm",
        ...
        [ConfigItem<bool>("LaunchAdvanceDisableJLW", false, ConfigSource.Local)]
        public partial bool DisableJlw { get; set; }
        [ConfigItem<bool>("LaunchAdvanceDisableRW", false, ConfigSource.Local)]
        public partial bool DisableRw { get; set; }
        ...
        [ConfigItem<int>("LaunchArgumentWindowWidth", 854, ConfigSource.Local)]
        public partial int WindowWidthLaunch { get; set; }
        [ConfigItem<int>("LaunchArgumentWindowHeight", 480, ConfigSource.Local)]
        public partial int WindowHeightLaunch { get; set; }
    ...
    [ConfigGroup("Instance")] partial class InstanceConfigGroup {
        [ConfigItem<string>("VersionAdvanceJvm", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> JvmArgs { get; }
        [ConfigItem<string>("VersionAdvanceGame", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> GameArgs { get; }
        [ConfigItem<int>("VersionAdvanceRenderer", 0, ConfigSource.GameInstance)]
        public partial ArgConfig<int> Renderer { get; }
        [ConfigItem<int>("VersionAdvanceAssets", 0, ConfigSource.GameInstance)]
        public partial ArgConfig<int> AssetVerifySolutionV1 { get; }
        [ConfigItem<bool>("VersionAdvanceAssetsV2", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> DisableAssetVerifyV2 { get; }
        [ConfigItem<bool>("VersionAdvanceJava", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> IgnoreJavaCompatibility { get; }
        [ConfigItem<bool>("VersionAdvanceDisableJlw", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> DisableJlwObsolete { get; }
        [ConfigItem<string>("VersionAdvanceRun", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> PreLaunchCommand { get; }
        [ConfigItem<bool>("VersionAdvanceRunWait", true, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> PreLaunchCommandWait { get; }
        [ConfigItem<bool>("VersionAdvanceDisableJLW", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> DisableJlw { get; }
        [ConfigItem<bool>("VersionAdvanceUseProxyV2", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> UseProxy { get; }
        [ConfigItem<bool>("VersionAdvanceDisableRW", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> DisableRw { get; }
        ...
        [ConfigItem<string>("VersionArgumentTitle", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> Title { get; }
        [ConfigItem<bool>("VersionArgumentTitleEmpty", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> UseGlobalTitle { get; }
        [ConfigItem<string>("VersionArgumentInfo", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> TypeInfo { get; }
        [ConfigItem<int>("VersionArgumentIndie", -1, ConfigSource.GameInstance)]
        public partial ArgConfig<int> IndieV1 { get; }
        [ConfigItem<bool>("VersionArgumentIndieV2", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> IndieV2 { get; }
        [ConfigItem<string>("VersionArgumentJavaSelect", "使用全局设置", ConfigSource.GameInstance)]
        public partial ArgConfig<string> SelectedJava { get; }
        [ConfigItem<string>("VersionServerEnter", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> ServerToEnter { get; }
        [ConfigItem<int>("VersionServerLoginRequire", 0, ConfigSource.GameInstance)]
        public partial ArgConfig<int> LoginRequirementSolution { get; }
        [ConfigItem<string>("VersionServerAuthRegister", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> AuthRegisterAddress { get; }
        [ConfigItem<string>("VersionServerAuthName", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> AuthServerDisplayName { get; }
        [ConfigItem<string>("VersionServerAuthServer", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> AuthServerAddress { get; }
        [ConfigItem<bool>("VersionServerLoginLock", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> AuthTypeLucked { get; }
        ...
        [ConfigItem<string>("VersionLegacyFabric", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> LegacyFabricVersion { get; }
        ...
        [ConfigItem<bool>("VersionLiteLoader", false, ConfigSource.GameInstance)]
        public partial ArgConfig<bool> HasLiteLoader { get; }
        ...
        [ConfigItem<string>("VersionCleanroom", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> CleanroomVersion { get; }
        [ConfigItem<int>("VersionApiCode", -1, ConfigSource.GameInstance)] public partial ArgConfig<int> SortCode { get; }
        [ConfigItem<string>("VersionOriginal", "Unknown", ConfigSource.GameInstance)]
        public partial ArgConfig<string> McVersion { get; }
        [ConfigItem<int>("VersionOriginalMain", -1, ConfigSource.GameInstance)]
        public partial ArgConfig<int> VersionMajor { get; }
        [ConfigItem<int>("VersionOriginalSub", -1, ConfigSource.GameInstance)] public partial ArgConfig<int> VersionMinor { get; }
        [ConfigItem<string>("VersionModpackVersion", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> ModpackVersion { get; }
        [ConfigItem<string>("VersionModpackSource", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> ModpackSource { get; }
        [ConfigItem<string>("VersionModpackId", "", ConfigSource.GameInstance)]
        public partial ArgConfig<string> ModpackId { get; }
    }
}
